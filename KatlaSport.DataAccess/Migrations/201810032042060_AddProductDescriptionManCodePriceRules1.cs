namespace KatlaSport.DataAccess.Migrations
{
    ...
    public partial class AddProductDescriptionManCodePriceRules1 : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.catalogue_products", "product_manufacturer_code", c => c.String(nullable: true, maxLength: 10));
